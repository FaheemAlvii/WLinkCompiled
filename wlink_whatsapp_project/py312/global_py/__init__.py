...
def generate_payload(self, model='wlink.project.wizard', template_mode=True, template_name=None, document_name=None):
    ...
    if template_mode:
        payload['context'] = {  # noqa
            ...
            'message': f"Hello {self.partner_id.name}, we have received your task regarding {self.name}. Our team will get back to you shortly. Thank you!"
        }
    else:
